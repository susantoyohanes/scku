#!/bin/bash
#shadowsocks-libev obfs install by NATANVPN
...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/susantoyohanes/izin/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# Link Hosting Kalian
akbarvpn="https://raw.githubusercontent.com/susantoyohanes/scku/main/shadowsocks"
